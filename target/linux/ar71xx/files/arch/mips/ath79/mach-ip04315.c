...
#define AP147_GPIO_LED_WLAN_2G	2

#define AP147_GPIO_BTN_RST	0
...
static struct gpio_led ap147_leds_gpio[] __initdata = {
	{
		.name		= "ip04315:green:status",
		.gpio		= AP147_GPIO_LED_STATUS,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:wlan-2g",
		.gpio		= AP147_GPIO_LED_WLAN_2G,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:lan1",
		.gpio		= AP147_GPIO_LED_LAN1,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:lan2",
		.gpio		= AP147_GPIO_LED_LAN2,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:lan3",
		.gpio		= AP147_GPIO_LED_LAN3,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:lan4",
		.gpio		= AP147_GPIO_LED_LAN4,
		.active_low	= 1,
	}, {
		.name		= "ip04315:green:wan",
...
static void __init ip04315_setup(void)
{
	...
	//caldata, mac address
	ath79_register_wmac(art + AP147_WMAC_CALDATA_OFFSET, art + AP_147_ART_MAC_OFFSET);

	ath79_setup_ar933x_phy4_switch(false, false);
	
	ath79_register_mdio(0, 0x0);
	//ath79_register_mdio(1, 0x0); //qsdk

	/* LAN */
	ath79_eth1_data.phy_if_mode = PHY_INTERFACE_MODE_GMII;
	ath79_eth1_data.duplex = DUPLEX_FULL;
	ath79_switch_data.phy_poll_mask |= BIT(4);
	ath79_init_mac(ath79_eth1_data.mac_addr, art + AP_147_ART_MAC_OFFSET, 0);
	...
	ath79_init_mac(ath79_eth0_data.mac_addr, art + AP_147_ART_MAC_OFFSET, 1);
	ath79_register_eth(0);
}

MIPS_MACHINE(ATH79_MACH_IP04315, "IP04315", "TOTOLINK IP04315 reference board", ip04315_setup);
